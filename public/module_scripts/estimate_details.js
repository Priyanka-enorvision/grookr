$(document).ready(function () {
	...
	var xin_table_document = $('#xin_table_document').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "user-documents-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
	...
	var xin_table_allowances_ad = $('#xin_table_all_allowances').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "allowance-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	var xin_table_commissions_ad = $('#xin_table_all_commissions').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "commissions-list/" + $('#user_id').val(),
			type: 'GET'
		},
		"language": {
			"lengthMenu": dt_lengthMenu,
	...
	var xin_table_statutory_deductions_ad = $('#xin_table_all_statutory_deductions').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "statutory-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	var xin_table_other_payments_ad = $('#xin_table_all_other_payments').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "other-payments-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	$('.payroll-modal-data').on('show.bs.modal', function (event) {
		...
		var modal = $(this);
		$.ajax({
			url: main_url + "estimate-to-invoice",
			type: "GET",
	...
	var xin_table_leave = $('#xin_table_leave').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "leave-lists/" + $('#user_id').val(),
			type: 'GET',
			dataTable: 'JSON',
			headers: {
				'X-Requested-With': 'XMLHttpRequest'
	...
	var xin_table_expense = $('#xin_table_expense').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "expense-lists/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_loan = $('#xin_table_loan').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "loan-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_travel = $('#xin_table_travel').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "travel-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_ad_salary = $('#xin_table_ad_salary').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "advance-salary-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_overtime = $('#xin_table_overtime').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "overtime-request-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_awards = $('#xin_table_awards').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "awards-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_projects = $('#xin_table_projects').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "projects-record-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_tasks = $('#xin_table_tasks').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "tasks-record-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
	...
	var xin_table_payslip = $('#xin_table_payslip').dataTable({
		"bDestroy": true,
		"ajax": {
			url: main_url + "payslip-history-list/" + $('#user_id').val(),
			type: 'GET',
			dataType: 'JSON',
			headers: {
				'X-Requested-With': "XMLHttpRequest"
...
$(document).on("click", ".delete", function () {
	...
	$('#delete_record').attr('action', main_url + 'delete_' + $(this).data('field_type'));
});