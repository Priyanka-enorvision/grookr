...
function floatchart() {
	...
	$(function () {
		$.ajax({
			url: main_url + 'leave-status-chart',
			contentType: "application/json; charset=utf-8",
			dataType: "json",
			success: function (response) {
	...
	$(function () {
		$(function () {
			...
			$.ajax({
				...
				url: main_url + 'planing-monthly-chart',
				type: 'GET',
				dataType: 'json',
				headers: {
				...
				success: function (response) {
					...
					var chart = new ApexCharts(document.querySelector("#monthly-planning-chart"), options);
					chart.render();
				},
				error: function (data) {
					console.log(data);
	...
	$(function () {
		$(function () {
			const csrfToken = $('meta[name="csrf-token"]').attr('content');
			$.ajax({
				url: main_url + 'invoice-amount-chart',
				type: 'GET',
				dataType: 'json',
				headers: {
					'X-Requested-With': 'XMLHttpRequest',
	...
	$(function () {
		const csrfToken = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url: main_url + 'task-status-chart',
			type: 'GET',
			dataType: 'json',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	$(function () {
		...
		$.ajax({
			...
			url: main_url + 'project-status-chart',
			type: 'GET',
			dataType: 'json',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	$(function () {
		const csrfToken = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url: main_url + 'department-wise-chart',
			type: 'GET',
			dataType: 'json',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	$(function () {
		const csrfToken = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url: main_url + 'designation-wise-chart',
			type: 'GET',
			dataType: 'json',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
	...
	$(function () {
		const csrfToken = $('meta[name="csrf-token"]').attr('content');
		$.ajax({
			url: main_url + 'staff-working-statusChart',
			type: 'GET',
			dataType: 'json',
			headers: {
				'X-Requested-With': 'XMLHttpRequest',
