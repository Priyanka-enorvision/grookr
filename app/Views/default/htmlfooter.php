...
<script type="text/javascript">
	...
	var processing_request = '<?= lang('Login.xin_processing_request'); ?>';
</script>
<script type="text/javascript">
	var dt_lengthMenu = '<?= lang('Datatables.xin_dt_lengthMenu'); ?>';
</script>
<script type="text/javascript">
	var dt_zeroRecords = '<?= lang('Datatables.xin_dt_zeroRecords'); ?>';
</script>
<script type="text/javascript">
	var dt_info = '<?= lang('Datatables.xin_dt_info'); ?>';
</script>
<script type="text/javascript">
	var dt_infoEmpty = '<?= lang('Datatables.xin_dt_infoEmpty'); ?>';
</script>
<script type="text/javascript">
	var dt_infoFiltered = '<?= lang('Datatables.xin_dt_infoFiltered'); ?>';
</script>
<script type="text/javascript">
	var dt_search = '<?= lang('Datatables.xin_dt_search'); ?>';
</script>
<script type="text/javascript">
	var dt_first = '<?= lang('Datatables.dt_first'); ?>';
</script>
<script type="text/javascript">
	var dt_previous = '<?= lang('Datatables.dt_previous'); ?>';
</script>
<script type="text/javascript">
	var dt_next = '<?= lang('Datatables.dt_next'); ?>';
</script>
<script type="text/javascript">
	var dt_last = '<?= lang('Datatables.dt_last'); ?>';
</script>
<script type="text/javascript">
	var main_url = '<?= site_url('erp/'); ?>';
</script>
<script type="text/javascript">
	var processing_request = '<?= lang('Login.xin_processing_request'); ?>';
</script>
<script type="text/javascript">
	var request_submitted = '<?= lang('Dashboard.xin_hr_request_submitted'); ?>';
</script>
