...
<ul class="pc-navbar">  
  ...
  <!-- Membership -->
  <li class="pc-item <?php if(!empty($arr_mod['membership_active']))echo $arr_mod['membership_active'];?>"><a href="<?= site_url('erp/subscriptions');?>" class="pc-link "><span class="pc-micon"><i data-feather="calendar"></i></span><span class="pc-mtext">
  ...
  <!-- Web Leads  -->
  <li class="pc-item <?php if(!empty($arr_mod['web_leads_details_active']))echo $arr_mod['web_leads_details_active'];?>"><a href="<?= site_url('erp/web-leads');?>" class="pc-link "><span class="pc-micon"><i data-feather="git-merge"></i></span><span class="pc-mtext">
    <?php echo "Web Leads";?>
    </span></a></li>
  <li class="pc-item pc-caption">
    <label>
