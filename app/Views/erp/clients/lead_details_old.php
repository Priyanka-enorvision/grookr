            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="<?= lang('Main.xin_organisation_name');?>" name="organisation_name" type="text" value="<?= $result['organisation_name'];?>">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="<?= lang('Main.xin_designation');?>" name="designation" type="text" value="<?= $result['designation'];?>">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control" name="lead_status" data-plugin="select_hrm" data-placeholder="<?= lang('Main.xin_lead_status');?>">
                    <option value="1" <?php if('1'==$result['lead_status']):?> selected="selected"<?php endif;?>>
                    <?= lang('Main.xin_hot');?>
                    </option>
                    <option value="2"<?php if('2'==$result['lead_status']):?> selected="selected"<?php endif;?>>
                    <?= lang('Main.xin_cold');?>
                    </option>
                  </select>
                </div>
