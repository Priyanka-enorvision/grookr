...
///
$invoice_id = $request->getUri()->getSegment(3);
...
if ($user_info['user_type'] == 'staff') {
  ...
  $get_invoice = $EstimatesModel->where('company_id', $user_info['company_id'])->where('estimate_id', $invoice_id)->first();
  ...
  $get_invoice = $EstimatesModel->where('company_id', $usession['sup_user_id'])->where('estimate_id', $invoice_id)->first();
  $invoice_items = $EstimatesitemsModel->where('estimate_id', $invoice_id)->findAll();
}
      ...
      <div class="card-body" aria-expanded="true" style="">
        <div class="row m-b-1">
          <div class="col-md-12">
            ...
            <?php $hidden = array('token' => $invoice_id); ?>
            <?php echo form_open('erp/update-estimate', $attributes, $hidden); ?>
            <div class="bg-white">
              <div class="box-block">
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control" placeholder="<?= lang('Main.xin_estimate_number'); ?>" name="estimate_number" type="text" value="<?= $get_invoice['estimate_number']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input class="form-control date" placeholder="<?= lang('Main.xin_estimate_date'); ?>" name="estimate_date" type="text" value="<?= $get_invoice['estimate_date']; ?>">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input class="form-control date" placeholder="<?= lang('Main.xin_estimate_due_date'); ?>" name="estimate_due_date" type="text" value="<?= $get_invoice['estimate_due_date']; ?>">
                        <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div data-repeater-item="">
                              <div class="row item-row">
                                <div class="form-group mb-1 col-sm-12 col-md-5">
                                  <input type="hidden" name="item[<?php echo $item['estimate_item_id']; ?>]" value="<?php echo $item['estimate_item_id']; ?>" />
                                  <label for="item_name">
                                    <?= lang('Invoices.xin_title_item'); ?>
                                  </label>
                                  <br>
                                  <input type="text" class="form-control item_name" name="eitem_name[<?php echo $item['estimate_item_id']; ?>]" id="item_name" placeholder="Item Name" value="<?= $item['item_name']; ?>">
                                </div>
                                <div class="form-group mb-1 col-sm-12 col-md-2">
                                  ...
                                  <br>
                                  <input type="text" class="form-control qty_hrs" name="eqty_hrs[<?php echo $item['estimate_item_id']; ?>]" id="qty_hrs" value="<?= $item['item_qty']; ?>">
                                </div>
                                <div class="skin skin-flat form-group mb-1 col-sm-12 col-md-2">
                                  ...
                                  <br>
                                  <input class="form-control unit_price" type="text" name="eunit_price[<?php echo $item['estimate_item_id']; ?>]" value="<?= $item['item_unit_price']; ?>" id="unit_price" />
                                </div>
                                <div class="form-group mb-1 col-sm-12 col-md-2">
                                  <label for="profession">
                                    <?= lang('Invoices.xin_subtotal'); ?>
                                  </label>
                                  <input type="text" class="form-control sub-total-item" readonly="readonly" name="esub_total_item[<?php echo $item['estimate_item_id']; ?>]" value="<?= $item['item_sub_total']; ?>" />
                                  <!-- <br>-->
                                ...
                                <div class="form-group col-sm-12 col-md-1 text-xs-center mt-2">
                                  ...
                                  <?php else: ?>
                                    <button type="button" class="btn icon-btn btn-sm btn-outline-danger waves-effect waves-light remove-invoice-item-ol" data-repeater-delete="" data-record-id="<?= uencode($item['estimate_item_id']); ?>"> <span class="fa fa-trash"></span></button>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <label for="invoice_note">
                            <?= lang('Main.xin_estimate_note'); ?>
                          </label>
                          <textarea name="estimate_note" class="form-control"><?= $get_invoice['estimate_note']; ?>
</textarea>
                        </div>
                      </div>
                    </div>
