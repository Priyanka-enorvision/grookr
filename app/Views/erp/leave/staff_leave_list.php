  ...
  <div class="col-md-12">
    <?php if (in_array('leave3', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
      <div id="add_form" class="collapse add-form" data-parent="#accordion" style="">
        ...
        <?php echo form_open('erp/add-leave', $attributes, $hidden); ?>
        <div class="row">
          <div class="col-md-8">
            <div class="card mb-2">
              <div id="accordion">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input class="form-control " placeholder="<?= lang('Projects.xin_start_date'); ?>" name="start_date" type="date" value="" min="<?php echo date('Y-m-d'); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input class="form-control" placeholder="<?= lang('Projects.xin_end_date'); ?>" name="end_date" type="date" value="" min="<?php echo date('Y-m-d'); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
