      ...
      <div class="col-xl-12 col-md-12">
        <div class="card proj-t-card">
          <div class="card-body">
            ...
            <?= form_open('erp/set-clocking', $attributes, $hidden); ?>
            ...
            <?php } else { ?>
              ...
              <input type="hidden" value="<?= uencode($attendance_value[0]->time_attendance_id); ?>" name="time_id"
                id="time_id">
              <div class="row align-items-center text-center">
                <div class="col">
                  <h6 class="m-b-0">
