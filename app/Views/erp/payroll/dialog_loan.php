...
*/
$get_animate = '';
if($request->getGet('data') === 'loan_amount' && $request->getGet('field_id')){
...
<div class="modal-body">
  ...
  <div class="col-md-6">
    ...
    <div class="alert alert-success" role="alert">
        <?= lang('Main.xin_loan_request_accepted');?>
    </div>
    <?php endif;?>
    <?php if($result['status']=='2'):?>
    <div class="alert alert-danger" role="alert">
        <?= lang('Main.xin_loan_request_rejected');?>
    </div>
    <?php endif;?>
</div>
<!--</div>-->
