                  ...
                  <table class="table m-b-0 f-14 b-solid requid-table">
                    ...
                    <tbody class="text-muted">
                      ...
                      if ($count_pay_allowance > 0) { ?>
                        ...
                        <?php endforeach ?>
                      <?php } ?>
                      <?php $commission_amount = 0;
                      if ($count_pay_commission > 0) { ?>
                        ...
                        <?php endforeach ?>
                      <?php } ?>
                      <?php $otherpayment_amount = 0;
                      if ($count_pay_otherpayment > 0) { ?>
              ...
              <div class="col-md-6">
                <div class="table-responsive">
                  <table class="table m-b-0 f-14 b-solid requid-table">
                    ...
                    <tbody class="text-muted">
                      <?php $statutory_amount = 0;
                      if ($count_pay_statutory > 0) { ?>
                ...
                <table class="table table-responsive invoice-table invoice-total">
                  <tbody>
                    ...
                    <tr class="text-info">
                      <td>
                        <hr>
                        <h5 class="text-primary m-r-10"><?php echo lang('Payroll.xin_net_pay'); ?> :</h5>
                      </td>
                      <td>
                        <hr>
