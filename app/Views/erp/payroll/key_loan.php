...
<div class="row m-b-1 animated fadeInRight">
  <div class="col-md-12">
    <?php if (in_array('loan2', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
      <div id="add_form" class="collapse add-form <?php echo $get_animate; ?>" data-parent="#accordion" style="">
        <?php $attributes = array('name' => 'add_loan', 'id' => 'xin-form', 'autocomplete' => 'off'); ?>
        <?php $hidden = array('_user' => '1'); ?>
        <?php echo form_open_multipart('erp/add-loan', $attributes, $hidden); ?>
        <div class="row">
          <div class="col-md-12">
            <div class="card mb-2">
              <div id="accordion">
