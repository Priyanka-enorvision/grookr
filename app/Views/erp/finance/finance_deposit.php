...
<?php } ?>
<?php if (in_array('deposit2', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
  <div id="add_form" class="collapse add-form" data-parent="#accordion" style="">
    <?php $attributes = array('name' => 'add_deposit', 'id' => 'xin-form', 'autocomplete' => 'off'); ?>
    <?php $hidden = array('_user' => '1'); ?>
    <?php echo form_open('erp/add-deposit', $attributes, $hidden); ?>
    <div class="row">
      <div class="col-md-8">
        <div class="card mb-2">
          <div id="accordion">
...
<div class="card user-profile-list">
  <div class="card-header">
    ...
    <div class="card-header-right">
      <?php if (in_array('dep_cat1', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
        <a href="<?= site_url('erp/income-type'); ?>" class="collapsed btn btn-sm waves-effect waves-light btn-primary m-0"> <i data-feather="plus"></i>
