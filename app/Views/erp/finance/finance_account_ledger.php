                                                    ...
                                                    <td>
                                                        <a href="<?= site_url() ?>">
                                                            <img class="img-fluid" width="171" height="30"
                                                                src="<?= base_url('uploads/logo/other/' . ($ci_erp_settings['other_logo'] ?? 'default_logo.png')) ?>"
                                                                onerror="this.src='<?= base_url('uploads/logo/other/default_logo.png') ?>'"
                                                                alt="Company Logo">
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <table class="table invoice-detail-table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <a href="<?= site_url('erp/transaction-details/') . uencode($transation['transaction_id']); ?>" class="text-secondary" style="text-decoration:none;">
                                                            <h6><?= $type['category_name']; ?></h6>
                                                            <p class="m-0"><?= $transation['description']; ?></p>
                                                        </a>
                                                    </td>
