...
<div class="row justify-content-center"> 
      ...
      <div class="card-body text-center">
        <div class="row align-items-center m-l-0">
          <div class="col-sm-6 text-left">
            <h5>
              <?= lang('Projects.xin_companies_management');?>
            </h5>
          </div>
          <div class="col-sm-6 text-right"> <span class="m-r-15"><?= lang('Projects.xin_view_mode');?>:</span> 
            <a href="<?= site_url().'erp/companies-list';?>" class="btn btn-sm waves-effect waves-light btn-primary btn-icon m-0" data-toggle="tooltip" data-placement="top" title="<?= lang('Projects.xin_list_view');?>"> <i class="fas fa-list-ul"></i> </a> 
            <a href="<?= site_url().'erp/companies-grid';?>" class="btn btn-sm waves-effect waves-light btn-primary btn-icon m-0" data-toggle="tooltip" data-placement="top" title="<?= lang('Projects.xin_grid_view');?>"> <i class="fas fa-th-large"></i> </a> 
            <?php if(in_array('client2',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
 ...
 <?php if($get_companies != null) { ?>
    <?php foreach($get_companies as $r) { ?>
    <?php
        if($r['is_active'] == 1){
    ...
    <div class="col-lg-4 col-md-6">
        ...
        <div class="card-body pt-0">
            ...
            <div class="row align-items-end">
                ...
                <div class="col"><img class="img-radius img-fluid wid-80" src="<?= base_url().'/public/uploads/clients/thumb/'.$r['profile_photo'];?>" alt="<?= $r['company_name'];?>"></div>
                <div class="col text-right pb-3">
                <?php if(in_array('client3',staff_role_resource()) || in_array('client4',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
                <div class="dropdown"> <a class="drp-icon dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal"></i></a>
                    ...
                    <?php if(in_array('client3',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
                        <a class="dropdown-item" href="<?= site_url('erp/view-client-info').'/'.uencode($r['user_id']);?>"><i class="feather icon-eye"></i>
                    <?= lang('Main.xin_view');?>
                    </a> 
                    <?php } ?>
                    <?php if(in_array('client4',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
