...
if ($user_info['user_type'] == 'staff') {
  $get_jobs = $JobsModel->where('company_id', $user_info['company_id'])->where('status', 1)->orderBy('job_id', 'ASC')->paginate(9);
            ...
            <div class="card-body">
              ...
              <div class="m-t-30">
                ...
                <div class="task-board m-0 float-right">
                  <?php if ($r['status'] == 1) { ?>
                    <a href="<?= site_url() . 'erp/view-job/' . $r['job_id']; ?>" data-toggle="tooltip" data-placement="top" title="<?= lang('Recruitment.xin_view_job'); ?>" class="btn btn-primary"><i class="fas fa-eye m-0"></i></a>
                  <?php } ?>
                    ...
                    <div class="dropdown-secondary dropdown d-inline">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <?php if (in_array('ats4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                          <a class="dropdown-item" href="<?= site_url() . 'erp/edit-a-job/' . $r['job_id']; ?>"><i data-feather="edit"></i>
