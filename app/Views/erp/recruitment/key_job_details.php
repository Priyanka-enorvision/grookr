...
?>
<?php if ($job_data['minimum_experience'] == 0): $experience = lang('Recruitment.xin_job_fresh');
endif; ?>
<?php if ($job_data['minimum_experience'] == 1): $experience = lang('Employees.xin_1year');
endif; ?>
<?php if ($job_data['minimum_experience'] == 2): $experience = lang('Employees.xin_2years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 3): $experience = lang('Employees.xin_3years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 4): $experience = lang('Employees.xin_4years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 5): $experience = lang('Employees.xin_5years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 6): $experience = lang('Employees.xin_6years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 7): $experience = lang('Employees.xin_7years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 8): $experience = lang('Employees.xin_8years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 9): $experience = lang('Employees.xin_9years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 10): $experience = lang('Employees.xin_10years');
endif; ?>
<?php if ($job_data['minimum_experience'] == 11): $experience = lang('Employees.xin_10plus_years');
endif; ?>
      ...
      <?php if ($count_job == 0) { ?>
        <div id="apply_form" class="collapse apply-form" data-parent="#accordion" style="">
          <div id="accordion">
            ...
            <?php $hidden = array('token' => $ifield_id); ?>
            <?= form_open('erp/apply-job', $attributes, $hidden); ?>
            <div class="card-body">
              <div class="row">
