...
<div class="row m-b-1 animated fadeInRight">
  <div class="col-md-12">
    <?php if (in_array('erp3', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
      ...
      <?= form_open('erp/add-job', $attributes, $hidden); ?>
      <div class="card mb-2">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input class="form-control " placeholder="<?php echo lang('Recruitment.xin_date_of_closing'); ?>" name="date_of_closing" type="date" value="">
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
