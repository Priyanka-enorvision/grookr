...
$award_id = $request->getUri()->getSegment(3);
            ...
            <tr>
              ...
              <td class="text-right">
                <?php if ($result['award_photo'] != '' && $result['award_photo'] != 'no file') { ?>
                  <a href="<?php echo site_url() ?>download?type=awards&filename=<?php echo $result['award_photo']; ?>">
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <?php if (in_array('award3', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
          <div class="tab-pane fade" id="pills-edit" role="tabpanel" aria-labelledby="pills-edit-tab">
            ...
            <?php $hidden = array('_method' => 'EDIT', 'token' => $award_id); ?>
            <?php echo form_open('erp/update-award', $attributes, $hidden); ?>
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
