...
if ($user_info['user_type'] == 'staff') {
  ...
  $staff_info = $UsersModel->where('company_id', $usession['sup_user_id'])->where(['user_type' => 'staff', 'is_active' => 1])->findAll();
}
/* Assets view
 */
$get_animate = '';
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?= lang('Employees.xin_complaint_title'); ?>" name="title"
                      type="text">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input class="form-control" placeholder="<?= lang('Employees.xin_complaint_date'); ?>"
                        name="complaint_date" type="date" id="complaint_date" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-7">
                  <div class="form-group">
                    ...
                    <select multiple class="form-control" data-plugin="select_hrm"
                      data-placeholder="<?= lang('Employees.xin_complaint_employees'); ?>" name="complaint_against[]">
                      <option value="">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control textarea" placeholder="<?= lang('Main.xin_description'); ?>"
