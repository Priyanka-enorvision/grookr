...
<div class="form-group" id="department_ajax">
  ...
  <select class="form-control" name="department" id="department_id" data-plugin="select_hrm" data-placeholder="<?= lang('Employees.xin_transfer_department'); ?>">
    <option value="">
      <?= lang('Employees.xin_transfer_department'); ?>
    </option>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    jQuery("#department_id").change(function() {
      jQuery.get(main_url + "is-designation/" + jQuery(this).val(), function(data, status) {
