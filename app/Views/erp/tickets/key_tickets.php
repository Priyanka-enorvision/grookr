              ...
              <div class="row align-items-center">
                <div class="col border-right pr-0">
                  <div class="card-body inner-center">
                    ...
                    <div class="mt-2">
                      <?php if (in_array('helpdesk3', staff_role_resource()) || $user_info['user_type'] == 'company') { ?><a href="#" class="mr-3 text-muted" data-toggle="modal" data-target=".view-modal-data" data-field_id="<?= $r['ticket_id']; ?>"><i class="feather icon-edit mr-1"></i>
                          <?= lang('Main.xin_edit'); ?>
                        </a>
                      <?php } ?>
                      <?php if (in_array('helpdesk4', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
                        <a href="<?= site_url('erp/ticket-view') . '/' . $r['ticket_id']; ?>" class="mr-3 text-muted"><i class="feather icon-eye mr-1"></i>
                  ...
                  <div class="col-auto pl-0 right-icon">
                    <div class="card-body">
                      <ul class="list-unstyled mb-0">
                        <li><a href="<?= site_url('erp/ticket-view') . '/' . $r['ticket_id']; ?>" data-toggle="tooltip" data-placement="top" title="<?= lang('Dashboard.left_view_ticket'); ?>"><i class="feather icon-circle text-muted"></i></a></li>
                      </ul>
                    </div>
                  </div>
                <?php } ?>
