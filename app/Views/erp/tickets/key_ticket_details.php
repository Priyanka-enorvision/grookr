...
if (!empty($ticket_info)) {
  ...
  //
  if ($ticket_info['ticket_status'] == 1): $priority = lang('Projects.xin_low');
  elseif ($ticket_info['ticket_status'] == 2): $priority = lang('Main.xin_medium');
  elseif ($ticket_info['ticket_status'] == 3): $priority = lang('Projects.xin_high');
  elseif ($ticket_info['ticket_status'] == 4): $priority = lang('Main.xin_critical');
  endif;
  ...
  <div class="col-lg-4">
    <div class="card hdd-right-inner">
      ...
      <?php if (in_array('helpdesk6', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
        ...
        <?= form_open('erp/update-ticket-status', $attributes, $hidden); ?>
      <?php } ?>
      <div class="card-body">
    ...
    <div class="card">
      ...
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
          <?php $tr = 0;
          foreach ($ticket_reply as $_reply) { ?>
                ...
                <div class="col">
                  <div class="comment-top">
                    <h6>
                      ...
                      <small class="text-muted f-w-400"><?= time_ago($_reply['created_at']); ?></small>
                    </h6>
                  </div>
          ...
          <?php
          if (!empty($_ticket_reply['sent_by'])) {
          ?>
            <div class="card-body hd-detail hdd-admin border-bottom">
              ...
              <?= form_open('erp/add-ticket-reply', $attributes, $hidden); ?>
              <div class="row mt-4">
                <div class="col-sm-12">
                  <div class="form-group">
        ...
        <?php if (in_array('helpdesk8', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <div class="card-body task-comment">
              ...
              <?php $hidden = array('token' => $segment_id); ?>
              <?= form_open('erp/tickets-add-note', $attributes, $hidden); ?>
        ...
        <?php if (in_array('helpdesk7', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
          <div class="tab-pane fade" id="pills-files" role="tabpanel" aria-labelledby="pills-files-tab">
            <div class="card-body">
              ...
              <?php $hidden = array('token' => $segment_id); ?>
              <?= form_open('erp/tickets-add-attachment', $attributes, $hidden); ?>
              <div class="bg-white">
                <div class="row mt-4">
                  <div class="col-md-6">
                    <div class="form-group">
