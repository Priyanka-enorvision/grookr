                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-sm-custom" name="client" id="client_select" data-placeholder="<?= lang('Projects.xin_client'); ?>">
                                                ...
                                                <?php foreach ($clients as $client) { ?>
                                                    <option value="<?= $client['user_id']; ?>" <?= $project['client_id'] == $client['user_id'] ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-sm-custom" id="project_select" data-placeholder="<?= lang('Projects.xin_project'); ?>"
                                                value="<?= getProjectName($project['project_id']); ?>">
                                            <input type="hidden" name="project" value="<?= $project['project_id']; ?>">

                                            <!-- <select class="form-control input-sm-custom" name="project" id="project_select" data-placeholder="<?= lang('Projects.xin_project'); ?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control date input-sm-custom" placeholder="<?= lang('Invoices.xin_invoice_date'); ?>" name="invoice_date" type="text" value="">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control date input-sm-custom" placeholder="<?= lang('Invoices.xin_invoice_due_date'); ?>" name="invoice_due_date" type="text" value="">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div style="border: 1px solid #ddd; border-radius: 8px; padding: 16px; background: #f9f9f9;">
                                                        ...
                                                        <div style="margin-bottom: 16px;">
                                                            ...
                                                            <span style="float: right; font-size: 14px;"><?php echo $sc_show; ?><span class="sub_total">0</span></span>
                                                        </div>
                                                        ...
                                                        <div style="margin-bottom: 16px; padding: 12px; border: 1px solid #ddd; border-radius: 8px; background: #fff;">
                                                            <div style="display: flex; gap: 16px; align-items: center;">
                                                                ...
                                                                <div style="flex: 1;">
                                                                    ...
                                                                    <input type="text" name="discount_figure" class="form-control discount_figure" value="0" style="width: 100%; padding: 8px; text-align: right; border: 1px solid #ddd; border-radius: 4px;">
                                                                </div>
                                                                <!-- Discount Amount -->
                                                                <div style="flex: 1;">
                                                                    <label style="font-size: 12px; margin-bottom: 4px; display: block;"><?= lang('Invoices.xin_discount_amount'); ?></label>
                                                                    <input type="text" readonly name="discount_amount" value="0" class="discount_amount form-control" style="width: 100%; padding: 8px; text-align: right; border: 1px solid #ddd; border-radius: 4px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style="margin-bottom: 16px; padding: 12px; border: 1px solid #ddd; border-radius: 8px; background: #fff;">
                                                            <div style="display: flex; gap: 16px; align-items: center;">
                                                                ...
                                                                <div style="flex: 1;">
                                                                    ...
                                                                    <input type="text" readonly name="tax_rate" value="0" class="tax_rate form-control" style="width: 100%; padding: 8px; text-align: right; border: 1px solid #ddd; border-radius: 4px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style="margin-top: 16px; font-size: 16px; font-weight: bold;">
                                                            ...
                                                            <span style="float: right;"><?php echo $sc_show; ?> <span class="grand_total">0</span></span>
                                                        </div>
                                                    </div>
