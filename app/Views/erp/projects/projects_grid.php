  ...
  <div class="col-xl-12 col-lg-12 filter-bar">
    <nav class="navbar m-b-30 p-10">
      ...
      <div class="nav-item nav-grid f-view"> 
        ...
        :</span> 
        <a href="<?= site_url().'erp/projects-list';?>" class="btn btn-sm waves-effect waves-light btn-primary btn-icon m-0" data-toggle="tooltip" data-placement="top" title="<?= lang('Projects.xin_list_view');?>"> <i class="fas fa-list-ul"></i> </a> 
        <a href="<?= site_url().'erp/projects-grid';?>" class="btn btn-sm waves-effect waves-light btn-primary btn-icon m-0" data-toggle="tooltip" data-placement="top" title="<?= lang('Projects.xin_grid_view');?>"> <i class="fas fa-th-large"></i> </a>
        ...
        <div class="card card-border-c-blue">
          ...
          <div class="card-body card-task">
            ...
            <div class="task-board" style="float: inherit;">
              ...
              <div class="dropdown-secondary dropdown"> 
                <p class="task-revenue"><strong>
                    <?= lang('Main.xin_revenue');?>
                    : </strong><strong class="label label-primary">
                    <?= isset($r['revenue']) ? $r['revenue'] : 0;?>
                    </strong></p>
              </div>
            </div>
          </div>
