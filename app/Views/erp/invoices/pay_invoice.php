...
?>
  ...
  <?= form_open('erp/pay-invoice-record', $attributes, $hidden); ?>
  <input type="hidden" name="invoice_number" value="<?php echo $result['invoice_number'] ?>">
  ...
  <input type="hidden" name="invoice_date" value="<?php echo $result['invoice_date'] ?>">
  <input type="hidden" name="invoice_due_date" value="<?php echo $result['invoice_due_date'] ?>">
  <input type="hidden" name="discount_date" value="<?php echo isset($result['discount_date']) ? $result['discount_date'] : ''; ?>">
  <input type="hidden" name="invoice_note" value="<?php echo $result['invoice_note'] ?>">
