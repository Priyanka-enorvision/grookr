                ...
                <div class="card-body">
                  <div class="row">
                    <?php if ($user_info['user_type'] == 'company') { ?>
                      <?php $staff_info = $UsersModel->where('company_id', $usession['sup_user_id'])->where(['user_type' => 'staff', 'is_active' => 1])->findAll(); ?>
                      <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input class="form-control " placeholder="<?= lang('Employees.xin_exit_date'); ?>" name="exit_date" type="date" min="<?php echo date('Y-m-d'); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
