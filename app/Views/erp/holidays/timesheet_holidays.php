  ...
  <?php if (in_array('holiday2', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
    <div class="col-md-4">
      <div class="card">
        ...
        <?php echo form_open('erp/add-holiday', $attributes, $hidden); ?>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input class="form-control " placeholder="<?= lang('Projects.xin_start_date'); ?>" name="start_date" type="date" min="<?php echo date('Y-m-d'); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input class="form-control " placeholder="<?= lang('Projects.xin_end_date'); ?>" name="end_date" type="date" min="<?php echo date('Y-m-d'); ?>">
                </div>
              </div>
            </div>
          </div>
