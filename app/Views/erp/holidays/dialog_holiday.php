...
?>
  ...
  <?php echo form_open('erp/update-holiday', $attributes, $hidden); ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            <input class="form-control" name="start_date" type="date" value="<?php echo $result['start_date']; ?>" min="<?php echo date('Y-m-d'); ?>">
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="input-group">
            <input class="form-control" name="end_date" type="date" value="<?php echo $result['end_date']; ?>" min="<?php echo date('Y-m-d'); ?>">
          </div>
        </div>
      </div>
      <div class="col-md-6">
