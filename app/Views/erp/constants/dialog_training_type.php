...
<div class="modal-header">
  <h5 class="modal-title">
    <?= lang('Dashboard.left_edit_training_skill');?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="<?= lang('Dashboard.left_training_skill');?>" value="<?= $result['category_name'];?>">
      </div>
    </div>
  </div>
</div>
