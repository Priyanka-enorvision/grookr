...
<?php if (in_array('expense1', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
  <div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
    <ul class="nav nav-tabs step-anchor">
      ...
      <li class="nav-item active"> <a href="<?= site_url('erp/expense-type'); ?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fas fa-plus-square"></span>
          <?= lang('Dashboard.xin_categories'); ?>
          <div class="text-muted small">
            <?= lang('Finance.xin_add_expense_category'); ?>
          </div>
        </a> </li>
    </ul>
  </div>
...
<div class="row m-b-1 animated fadeInRight">
  <div class="col-md-12">
    <div class="row m-b-1 animated fadeInRight">
      <?php if (in_array('exp_cat2', staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <?php $attributes = array('name' => 'add_expense_type', 'id' => 'xin-form', 'autocomplete' => 'off'); ?>
              <?php $hidden = array('user_id' => '0'); ?>
              <?= form_open('erp/add-expense-type', $attributes, $hidden); ?>
