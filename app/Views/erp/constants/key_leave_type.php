    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?= form_open('erp/add-leave-type', $attributes, $hidden); ?>
          ...
          <div class="form-group">
            <label for="name">
              ...
              <span class="text-danger">*</span></label>
            <!-- <input type="number" class="form-control" name="days_per_year" placeholder="<?= lang('Leave.xin_leave_days_per_year'); ?>" min="1" max="30"> -->
            <input type="number" class="form-control" name="days_per_year" placeholder="<?= lang('Leave.xin_leave_days_per_year'); ?>">
