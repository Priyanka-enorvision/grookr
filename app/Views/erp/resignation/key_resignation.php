          ...
          <div class="row">
            ...
            <div class="<?= $colmd ?>">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input class="form-control" placeholder="<?= lang('Employees.xin_notice_date'); ?>" name="notice_date" type="date" min="<?= date('Y-m-d'); ?>">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input class="form-control" placeholder="<?= lang('Employees.xin_resignation_date'); ?>" name="resignation_date" type="date" min="<?= date('Y-m-d'); ?>">
                  <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                </div>
              </div>
            </div>
