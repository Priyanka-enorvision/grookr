...
class Backup_erp {
	 ...
	 * @access public
	 */
	public function __construct($dbhost,$database,$dbUser ,$dbPass, $path="public/uploads/dbbackup/") {
	...
	public function get_database_dump_filename() {
		...
		if ( empty( $this->database_dump_filename ) )
			$this->set_database_dump_filename( 'timehrm_backup_'.date('d-m-Y').'_'.time(). '.sql' );
